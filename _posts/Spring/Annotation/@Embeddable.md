...
tags:
  ...
  - Annotation
  - spring/Repository
특징: 엔티티 내에서 엔티티 가 아닌 클래스를 정의하는 어노테이션
---
# @Embeddable
- [[2.Ref(데이터 및 정보 저장)/Spring/용어설명/Entity|엔티티]] 내에서 [[2.Ref(데이터 및 정보 저장)/Spring/용어설명/Entity|엔티티]] 가 아닌 클래스를 정의하는 [[2.Ref(데이터 및 정보 저장)/Spring/Annotation/1.애노테이션(annotation)|어노테이션]]  
- [[2.Ref(데이터 및 정보 저장)/Spring/Annotation/@Embedded|@Embedded]] 와 쌍으로 사용
